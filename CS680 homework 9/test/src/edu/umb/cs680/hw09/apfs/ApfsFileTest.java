...
class ApfsFileTest {
	...
	private String[] FileToStringArray(ApfsFile d) {
		String[] FileInfo = { Boolean.toString(d.isDirectory()), d.getName(), Integer.toString(d.getSize()),
	...
	public void verifyApfsFileEqualityA() {
		APFS FilesystemApfs = APFS.getAPFSFileSystem();
		ApfsDirectory root = (ApfsDirectory) FilesystemApfs.getRootDir();
		String[] expected = { "false", "a", "350", localTime.toString(), "applications", "Prabin",
				localTime.toString() };
	...
	public void verifyApfsFileEqualityB() {
		APFS FilesystemApfs = APFS.getAPFSFileSystem();
		ApfsDirectory root = (ApfsDirectory) FilesystemApfs.getRootDir();
		String[] expected = { "false", "b", "700", localTime.toString(), "home", "Prabin", localTime.toString() };
	...
	public void verifyApfsFileEqualityC() {
		APFS FilesystemApfs = APFS.getAPFSFileSystem();
		ApfsDirectory root = (ApfsDirectory) FilesystemApfs.getRootDir();
		String[] expected = { "false", "c", "800", localTime.toString(), "code", "Prabin", localTime.toString() };
	...
	public void verifyApfsFileEqualityD() {
		APFS FilesystemApfs = APFS.getAPFSFileSystem();
		ApfsDirectory root = (ApfsDirectory) FilesystemApfs.getRootDir();
		String[] expected = { "false", "d", "80", localTime.toString(), "code", "Prabin", localTime.toString() };
	...
	public void verifyApfsFileEqualityE() {
		APFS FilesystemApfs = APFS.getAPFSFileSystem();
		ApfsDirectory root = (ApfsDirectory) FilesystemApfs.getRootDir();
		String[] expected = { "false", "e", "700", localTime.toString(), "pics", "Prabin", localTime.toString() };
	...
	public void verifyApfsFileEqualityF() {
		APFS FilesystemApfs = APFS.getAPFSFileSystem();
		ApfsDirectory root = (ApfsDirectory) FilesystemApfs.getRootDir();
		String[] expected = { "false", "f", "870", localTime.toString(), "pics", "Prabin", localTime.toString() };

...
class ApfsLinkTest {
	...
	private String[] LinkToStringArray(ApfsLink d) {
		String[] LinkInfo = { Boolean.toString(d.isDirectory()), d.getName(), Integer.toString(d.getSize()),
	...
	public void verifyLinkEqualityX() {
		...
		String[] expected = { "false", "x", "0", localTime.toString(), "home", "Prabin", localTime.toString(),
				"applications" };
	...
	public void verifyLinkEqualityY() {
		APFS fileSystemApfs = APFS.getAPFSFileSystem();
		ApfsDirectory root = (ApfsDirectory) fileSystemApfs.getRootDir();
		String[] expected = { "false", "y", "0", localTime.toString(), "code", "Prabin", localTime.toString(), "a" };

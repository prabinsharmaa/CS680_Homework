...
class ApfsDirectoryTest {
	...
	private String[] dirToStringArray(ApfsDirectory d) {
		...
		String[] dirInfo = { Boolean.toString(d.isDirectory()), d.getName(), Integer.toString(d.getSize()),
				...
				optionalDirectory.isPresent() ? d.getParent().getName() : null, Integer.toString(d.getTotalSize()),
	...
	public void verifyApfsDirectoryEqualityHome() {
		APFS fileSystemApfs = APFS.getAPFSFileSystem();
		ApfsDirectory root = (ApfsDirectory) fileSystemApfs.getRootDir();
		String[] expected = { "true", "home", "0", localTime.toString(), "root", "3150", "4", "Prabin",
				localTime.toString() };
	...
	public void verifyApfsDirectoryEqualityApplications() {
		APFS fileSystemApfs = APFS.getAPFSFileSystem();
		ApfsDirectory root = (ApfsDirectory) fileSystemApfs.getRootDir();
		String[] expected = { "true", "applications", "0", localTime.toString(), "root", "350", "1", "Prabin",
				localTime.toString() };
	...
	public void verifyApfsDirectoryEqualityCode() {
		APFS fileSystemApfs = APFS.getAPFSFileSystem();
		ApfsDirectory root = (ApfsDirectory) fileSystemApfs.getRootDir();
		String[] expected = { "true", "code", "0", localTime.toString(), "home", "880", "3", "Prabin",
				localTime.toString() };
	...
	public void verifyApfsDirectoryEqualityPics() {
		APFS fileSystemApfs = APFS.getAPFSFileSystem();
		ApfsDirectory root = (ApfsDirectory) fileSystemApfs.getRootDir();
		String[] expected = { "true", "pics", "0", localTime.toString(), "home", "1570", "2", "Prabin",
				localTime.toString() };

...
class AlphabeticalComparatorTest {
	...
	public void ChildrenHomeDiretoryComparatorTest() {
		...
		String[] actual = ApfsEleToString(
				(LinkedList<ApfsElement>) root.findDirectoryByName("home").getChildren(new AlphabeticalComparator()));
	...
	public void FilesInCodeDirectoryComparatorTest() {
		...
		String[] actual = APFSFileToString(
				(LinkedList<ApfsFile>) root.findDirectoryByName("code").getFiles(new AlphabeticalComparator()));
		assertArrayEquals(expected, actual);
	}
	...
	public void FileInPicsDirectoryComparatorTest() {
		...
		ApfsDirectory root = (ApfsDirectory) FilesystemApfs.getRootDir();
		String[] actual = APFSFileToString(
				(LinkedList<ApfsFile>) root.findDirectoryByName("pics").getFiles(new AlphabeticalComparator()));
		assertArrayEquals(expected, actual);
	}

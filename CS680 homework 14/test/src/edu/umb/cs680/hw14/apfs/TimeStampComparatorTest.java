...
class TimeStampComparatorTest {
	...
	public void FilesInCodeTimeComparatorTest() {
		...
		LinkedList<ApfsFile> l = root.findDirectoryByName("code").getFiles((ApfsElement arg1, ApfsElement arg2) -> arg1
				.getCreationTime().toString().compareTo(arg2.getCreationTime().toString()));
	...
	public void FilesInPicsTimeComparatorTest() {
		...
		APFS FileSystemApfs = APFS.getAPFSFileSystem();
		ApfsDirectory root = (ApfsDirectory) FileSystemApfs.getRootDir();
		LinkedList<ApfsFile> l = root.findDirectoryByName("pics").getFiles((ApfsElement arg1, ApfsElement arg2) -> arg1
				.getCreationTime().toString().compareTo(arg2.getCreationTime().toString()));
		assertArrayEquals(expected, APFSFileToString(l));
	}
	...
	public void ChildrenHomeTimeComparatorTest() {
		...
		APFS FileSystemApfs = APFS.getAPFSFileSystem();
		ApfsDirectory root = (ApfsDirectory) FileSystemApfs.getRootDir();
		LinkedList<ApfsElement> l = root.findDirectoryByName("home").getChildren((ApfsElement arg1,
				ApfsElement arg2) -> arg1.getCreationTime().toString().compareTo(arg2.getCreationTime().toString()));
	...
	public void RootDirectoryTimeComparatorTest() {
		...
		APFS FilesystemApfs = APFS.getAPFSFileSystem();
		ApfsDirectory root = (ApfsDirectory) FilesystemApfs.getRootDir();
		LinkedList<ApfsElement> l = root.findDirectoryByName("root").getChildren((ApfsElement arg1,
				ApfsElement arg2) -> arg1.getCreationTime().toString().compareTo(arg2.getCreationTime().toString()));
		assertArrayEquals(expected, ApfsEleToString(l));
	}
	...
	public void FileInHomeDirectoryTimeComparatorTest() {
		...
		APFS FilesystemApfs = APFS.getAPFSFileSystem();
		ApfsDirectory root = (ApfsDirectory) FilesystemApfs.getRootDir();
		LinkedList<ApfsFile> l = root.findDirectoryByName("home").getFiles((ApfsElement arg1, ApfsElement arg2) -> arg1
				.getCreationTime().toString().compareTo(arg2.getCreationTime().toString()));
		assertArrayEquals(expected, APFSFileToString(l));
	}

...
class ReverseAlphabeticalComparatorTest {
	...
	public void ChildrenHomeDiretoryComparatorTest() {
		...
		LinkedList<ApfsElement> l = root.findDirectoryByName("home")
				.getChildren((ApfsElement arg1, ApfsElement arg2) -> -arg1.getName().compareTo(arg2.getName()));
	...
	public void FilesInCodeDirectoryComparatorTest() {
		...
		APFS FilesystemApfs = APFS.getAPFSFileSystem();
		ApfsDirectory root = (ApfsDirectory) FilesystemApfs.getRootDir();
		LinkedList<ApfsFile> l = root.findDirectoryByName("code")
				.getFiles((ApfsElement arg1, ApfsElement arg2) -> -arg1.getName().compareTo(arg2.getName()));
	...
	public void FileInPicsDirectoryComparatorTest() {
		...
		APFS FilesystemApfs = APFS.getAPFSFileSystem();
		ApfsDirectory root = (ApfsDirectory) FilesystemApfs.getRootDir();
		LinkedList<ApfsFile> l = root.findDirectoryByName("pics")
				.getFiles((ApfsElement arg1, ApfsElement arg2) -> -arg1.getName().compareTo(arg2.getName()));
		assertArrayEquals(expected, APFSFileToString(l));
	}
	...
	public void ChildrenInRootDirectoryComparatorTest() {
		...
		APFS FilesystemApfs = APFS.getAPFSFileSystem();
		ApfsDirectory root = (ApfsDirectory) FilesystemApfs.getRootDir();
		LinkedList<ApfsElement> l = root.findDirectoryByName("root")
				.getChildren((ApfsElement arg1, ApfsElement arg2) -> -arg1.getName().compareTo(arg2.getName()));
		assertArrayEquals(expected, ApfsEleToString(l));
	}
	...
	public void FileInHomeDirectoryComparatorTest() {
		...
		APFS FilesystemApfs = APFS.getAPFSFileSystem();
		ApfsDirectory root = (ApfsDirectory) FilesystemApfs.getRootDir();
		LinkedList<ApfsFile> l = root.findDirectoryByName("home")
				.getFiles((ApfsElement arg1, ApfsElement arg2) -> -arg1.getName().compareTo(arg2.getName()));
		assertArrayEquals(expected, APFSFileToString(l));
	}
